...
export async function POST(request: Request) {
    ...
    [[+ДОБАВЛЕНО]] - для нового текста
    [[~БЫЛО→СТАЛО]] - для измененного текста  
    [[^ПЕРЕМЕЩЕНО]] - для текста, который поменял порядок
    ...
    Отдельно в конце напиши процент вероятности, с которой кандидат сможет получить эту работу. 
    Напиши вероятность в формате:
