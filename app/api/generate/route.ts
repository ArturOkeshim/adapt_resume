...
export async function POST(request: Request) {
    ...
    Отдельно в конце напиши процент вероятности, с которой кандидат мог получить эту работу с старым резюме
    и с новым, адаптированным резюме, где 0% - вообще нет шансов. 100% - новое резюме идеально подходит
    под вакансию. Не делай заглавие, просто напиши вероятность в формате:

    ---Старый вариант: ХХ%  Адаптированный вариант: ХХ%
    `
